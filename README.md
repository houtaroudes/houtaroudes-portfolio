...
- ⌨️ **Typewriter hero intro** with staggered entrance animations
- 🗂️ **Project Catalog** — filterable by category (All / Full Stack / Frontend), pulling in real project links and repos
- 🛠️ **Equipment Loadout** — animated skill badges for the tools and languages I use
